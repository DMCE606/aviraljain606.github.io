...
<body>
  ...
  <form class="modal-content animate" action="projectFac.php" method="post" >
    ...
    <div class="container">
      ...
      <input type="text" placeholder="Enter your ID" name="Fd_id" required>
      ...
      <input type="text" placeholder="Enter Qualification" name="Qua" required>
